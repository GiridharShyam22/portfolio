...
const STATS = [
  { value: 'AI / ML', sub: 'Vision · NLP · Pipelines', color: '#4f6ef7' },
  { value: 'Full-Stack', sub: 'React · Node · FastAPI', color: '#7c4fff' },
  { value: '15+', sub: 'Hackathons', color: '#00b4ff' },
  { value: '∞', sub: 'Learning Loop', color: '#f59e0b' },
];
            ...
            >
              <span
                ...
                style={{
                  ...
                  boxShadow: '0 0 10px rgba(79,110,247,0.1)',
  ...
  return (
    <section id="about" className="relative py-24 md:py-36 px-6 md:px-12 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 70% 60% at 10% 50%, rgba(29,32,102,0.15) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 90% 60%, rgba(79,110,247,0.06) 0%, transparent 50%)',
      }} />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span style={{
              background: 'linear-gradient(135deg, #8899ff 0%, #4f6ef7 40%, #00b4ff 100%)',
          ...
          >
            <div className="space-y-6">
              <div
                ...
                style={{ borderColor: 'rgba(79,110,247,0.5)' }}
              >
              ...
              {[
                ...
                >
                  <div className="text-2xl font-black" style={{
                    background: 'linear-gradient(135deg, #8899ff, #4f6ef7)',
                    WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
                  }}>{num}</div>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                ...
                style={{
                  background: 'radial-gradient(circle at 35% 35%, rgba(79,110,247,0.6), rgba(29,32,102,0.9) 60%, rgba(8,11,26,0.95))',
                  border: '1px solid rgba(79,110,247,0.4)',
                  boxShadow: '0 0 40px rgba(79,110,247,0.3), 0 0 80px rgba(79,110,247,0.15), inset 0 0 30px rgba(79,110,247,0.1)',
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="absolute w-[280px] h-[98px] rounded-full border border-dashed" style={{ borderColor: 'rgba(79,110,247,0.12)' }} />
              <div className="absolute w-[390px] h-[136px] rounded-full border border-dashed" style={{ borderColor: 'rgba(79,110,247,0.08)' }} />
            </div>
          </motion.div>
        </div>
