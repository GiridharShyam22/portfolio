    ...
    <>
      ...
      <motion.nav
        ...
        style={{
          ...
          boxShadow: scrolled
            ? '0 8px 40px rgba(3,4,14,0.6), 0 0 0 1px rgba(0,180,216,0.08), inset 0 1px 0 rgba(255,255,255,0.04)'
      ...
      >
          ...
          >
            ...
            {active === id && (
              <motion.div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(29,32,102,0.8), rgba(0,180,216,0.2))',
        ...
        <a
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(0,180,216,0.35), rgba(72,202,228,0.3))';
            e.currentTarget.style.boxShadow = '0 0 20px rgba(0,180,216,0.3)';
            e.currentTarget.style.color = '#fff';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(0,180,216,0.2), rgba(72,202,228,0.15))';
      ...
      <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 md:hidden">
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 -4px 40px rgba(3,4,14,0.6), 0 0 0 1px rgba(0,180,216,0.06)',
          }}
        >
          {NAV_ITEMS.map(({ id, label }) => (
            <a
