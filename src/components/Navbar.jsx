    ...
    <>
      ...
      <motion.nav
        ...
        style={{
          ...
          boxShadow: scrolled
            ? '0 8px 40px rgba(3,4,14,0.6), 0 0 0 1px rgba(79,110,247,0.08), inset 0 1px 0 rgba(255,255,255,0.04)'
      ...
      >
          ...
          >
            ...
            {active === id && (
              <motion.div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(29,32,102,0.8), rgba(79,110,247,0.2))',
        ...
        <a
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(79,110,247,0.2), rgba(124,79,255,0.15))',
            border: '1px solid rgba(79,110,247,0.4)',
            color: '#a5b4fc',
            boxShadow: '0 0 12px rgba(79,110,247,0.15)',
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(79,110,247,0.35), rgba(124,79,255,0.3))';
            e.currentTarget.style.boxShadow = '0 0 20px rgba(79,110,247,0.3)';
            e.currentTarget.style.color = '#fff';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(79,110,247,0.2), rgba(124,79,255,0.15))';
      ...
      <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 md:hidden">
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 -4px 40px rgba(3,4,14,0.6), 0 0 0 1px rgba(79,110,247,0.06)',
          }}
        >
          {NAV_ITEMS.map(({ id, label }) => (
            <a
