  ...
  return (
    <>
      <mesh ref={ring1} position={[6, 2, -4]}>
        ...
        <meshBasicMaterial color="#e8e4eb" transparent opacity={0.25} />
      </mesh>
      <mesh ref={ring2} position={[-7, -1, -3]}>
        <torusGeometry args={[0.9, 0.012, 8, 60]} />
        <meshBasicMaterial color="#e8e4eb" transparent opacity={0.2} />
      </mesh>
      <mesh position={[2, -3, -5]}>
        <torusGeometry args={[0.6, 0.01, 6, 40]} />
        <meshBasicMaterial color="#dbc0f0" transparent opacity={0.2} />
      </mesh>
    </>
  );
}
