...
function HoloAvatar({ imgSrc }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {[
          ...
          <div
            ...
            style={{ borderColor: 'rgba(0,180,216,0.8)' }}
          />
        ))}
        ...
        <div
          ...
          style={{
            boxShadow:
              '0 0 0 1px rgba(0,180,216,0.25), 0 0 50px rgba(0,180,216,0.35), 0 0 100px rgba(72,202,228,0.5), inset 0 0 40px rgba(72,202,228,0.3)',
          }}
        >
          {/* Photo */}
          <img
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(0,180,216,0.15) 0%, transparent 40%, rgba(72,202,228,0.1) 80%)',
            }}
          />
          ...
          <div
            ...
            style={{
              backgroundImage:
                'repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(0,180,216,0.04) 3px, rgba(0,180,216,0.04) 4px)',
              opacity: 0.8,
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to top, rgba(11,19,43,0.7), transparent)',
            }}
          />
        </div>
      ...
      >
        <div className="text-xl font-black" style={{ color: '#00b4d8' }}>15+</div>
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 0 16px rgba(72,202,228,0.2)',
          backdropFilter: 'blur(12px)',
        }}
      >
      ...
      >
        <div
          style={{
            ...
            height: '40%',
            background:
              'linear-gradient(to bottom, transparent, rgba(0,180,216,0.04) 50%, transparent)',
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: '0 0 30px rgba(0,180,216,0.4), 0 4px 20px rgba(0,180,216,0.3)',
      }}
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow =
          '0 0 45px rgba(0,180,216,0.65), 0 4px 30px rgba(0,180,216,0.5)';
        e.currentTarget.style.transform = 'translateY(-2px)';
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.boxShadow =
          '0 0 30px rgba(0,180,216,0.4), 0 4px 20px rgba(0,180,216,0.3)';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 90% 80% at 50% 0%, rgba(29,32,102,0.4) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 80% 80%, rgba(0,180,216,0.08) 0%, transparent 50%)',
        }}
      />
      ...
      <div className="max-w-7xl w-full mx-auto grid md:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="font-mono text-xs tracking-[0.2em] uppercase" style={{ color: 'rgba(0,180,216,0.6)' }}>
              AI/ML · Full-Stack
            </span>
          </motion.div>
          ...
          >
            <span className="block text-white" style={{ textShadow: '0 0 60px rgba(0,180,216,0.3)' }}>
              Giridhar
            </span>
            <span
              className="block"
              style={{
                background: 'linear-gradient(135deg, #00b4d8 0%, #00b4d8 40%, #00b4d8 80%)',
          ...
          >
            <span className="font-mono text-base md:text-lg" style={{ color: 'rgba(165,180,252,0.9)' }}>
              ...
              {role}
              <span
                className="inline-block w-0.5 h-5 bg-[#00b4d8] ml-0.5 align-middle"
            ...
            {skills.map(({ icon: Icon, label, sub }, i) => (
              <motion.div
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.borderColor = 'rgba(0,180,216,0.12)';
      ...
      >
        ...
        <div className="w-px h-10 relative overflow-hidden">
          <div
            className="absolute inset-0 bg-gradient-to-b from-[#00b4d8]/60 to-transparent"
