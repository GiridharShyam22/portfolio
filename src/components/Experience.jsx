...
const smallCards = [
  { icon: RiCodeSSlashLine, badge: 'Coordinator', title: 'GCC Coding Club', desc: 'Coordinating coding activities and events to foster programming culture.', color: '#e8e4eb' },
  { icon: RiTeamLine,       badge: 'Organizer',   title: 'Tech Expo',       desc: 'Organized a college-level Tech Expo with project showcases.', color: '#dbc0f0' },
  { icon: RiRocketLine,     badge: 'Builder',      title: 'AI & ML Projects', desc: 'Developed multiple AI/ML and full-stack projects solving real-world challenges.', color: '#e8e4eb' },
  { icon: RiAwardLine,      badge: 'Innovator',    title: 'Rapid Prototyping', desc: 'Consistent track record building functional prototypes under time constraints.', color: '#e8e4eb' },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold" style={{ fontFamily: 'Space Grotesk' }}>
            ...
            <span style={{
              background: 'linear-gradient(135deg, #e8e4eb, #e8e4eb, #dbc0f0)',
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            <h3 className="font-mono text-sm tracking-[0.2em] uppercase mb-8 flex items-center gap-3" style={{ color: 'rgba(121,134,203,0.7)' }}>
              <span style={{ color: '#e8e4eb' }}>/</span> Leadership
            </h3>
            {timeline.map((item, i) => (
          ...
          <div>
            <h3 className="font-mono text-sm tracking-[0.2em] uppercase mb-8 flex items-center gap-3" style={{ color: 'rgba(121,134,203,0.7)' }}>
              <span style={{ color: '#e8e4eb' }}>/</span> Recognition
            </h3>
