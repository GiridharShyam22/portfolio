  ...
  return (
    <section id="contact" className="relative py-24 md:py-36 px-6 md:px-12 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 80% 60% at 50% 100%, rgba(0,180,216,0.1) 0%, transparent 60%), radial-gradient(ellipse 40% 30% at 20% 50%, rgba(29,32,102,0.2) 0%, transparent 50%)',
      }} />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 0 80px rgba(0,180,216,0.08), inset 0 0 80px rgba(29,32,102,0.1)',
          }}
        >
          {/* Top accent line */}
          <div className="absolute inset-x-0 top-0 h-[2px]" style={{ background: 'linear-gradient(90deg, transparent, #00b4d8, #48cae4, #00b4d8, transparent)' }} />

          {/* Decorative corner ring */}
          <div className="absolute -right-20 -top-20 w-60 h-60 rounded-full pointer-events-none" style={{ border: '1px solid rgba(0,180,216,0.08)' }} />
          <div className="absolute -right-12 -top-12 w-40 h-40 rounded-full pointer-events-none" style={{ border: '1px solid rgba(0,180,216,0.06)' }} />
          ...
          <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="relative p-8 md:p-12 lg:p-16">
              ...
              >
                Let's Build{' '}
                <span style={{
                  background: 'linear-gradient(135deg, #00b4d8, #00b4d8, #00b4d8)',
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  style={{
                    ...
                    boxShadow: '0 0 30px rgba(0,180,216,0.35), 0 4px 20px rgba(0,180,216,0.25)',
                    color: '#fff',
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = '0 0 45px rgba(0,180,216,0.55), 0 4px 30px rgba(0,180,216,0.4)';
                    e.currentTarget.style.transform = 'translateY(-2px)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = '0 0 30px rgba(0,180,216,0.35), 0 4px 20px rgba(0,180,216,0.25)';
                    e.currentTarget.style.transform = '';
                  }}
                >
            ...
            <div
              ...
              style={{ borderColor: 'rgba(0,180,216,0.1)', background: 'rgba(3,4,14,0.3)' }}
            >
              {/* Direct email card */}
              <div
              ...
              >
                ...
                >
                  <Mail className="h-4 w-4 flex-shrink-0" style={{ color: '#00b4d8' }} />
