          ...
          <div className="grid lg:grid-cols-[1.15fr_0.85fr]">
            <div className="relative p-8 md:p-12 lg:p-16">
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                ...
                <a href="/CharansResume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex w-full items-center justify-center gap-3 rounded-2xl border border-emerald-300/15 bg-emerald-300/5 px-6 py-4 text-base font-bold text-white transition-all duration-300 hover:-translate-y-1 hover:border-emerald-300/35 hover:bg-emerald-300/10 sm:w-auto">
